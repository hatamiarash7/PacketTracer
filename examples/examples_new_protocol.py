...
Last but not least: every protocol needs a testcase in tests/test_packetracer.py
"""
import logging
...
class Option(packetracer.Packet):
...
class NewProtocol(packetracer.Packet):
    """
    ...
    # for classes "MetaPacket" and "Packet" in packetracer/packetracer.py for
    # deeper information.
    __hdr__ = (
    ...
    # Conveniant access should be enabled using properties eg using packetracer.get_property_xxx(...)
    src_s = packetracer.get_property_ip4("src")
    dst_s = packetracer.get_property_ip4("dst")

    # xxx_s = packetracer.get_property_mac("xxx")
    # xxx_s = packetracer.get_property_dnsname("xxx")
    ...
    def bin(self, update_auto_fields=True):
        ...
        """
        return packetracer.Packet.bin(self, update_auto_fields=update_auto_fields) + b"somepadding"
